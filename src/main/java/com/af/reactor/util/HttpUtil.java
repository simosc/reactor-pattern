...
public class HttpUtil {
	...
	public static void writeResponse(String content, SocketChannel channel)
			throws IOException {

		HttpUtil.writeResponse(createResponseHeader(content), channel);
	}

	public static void writeResponse(String content, OutputStream out)
			throws IOException {

		HttpUtil.writeResponse(createResponseHeader(content), out);
	}

	private static HttpResponse createResponseHeader(String content) {
		...
		response.addHeader(HTTP.CONTENT_LEN, String.valueOf(content.length()));
